...
async function usePointsInPolygon(rings) {
  ...
  let features = await fetch('https://njs-drainage-ueredeveloper.replit.app/findSuperficialPointsInsidePolygon',
    {
      method: 'POST',
      headers: {
...
async function usePointsByUH(uh_codigo) {

  let features = await fetch(`https://njs-drainage-ueredeveloper.replit.app/findSuperficialPointsByUH?uh_codigo=${uh_codigo}`,
    {
      method: 'GET',
      headers: {
        "Content-type": "application/json",
